...
namespace DFC.App.JobProfiles.JobProfileOverview.MFA.UnitTests.Services
{
    ...
    public class HttpClientServicePutTests
    {
        ...
        public async Task PutFullJobProfileAsyncReturnsOkStatusCodeForExistingId()
        {
            ...
            // act
            var result = await httpClientService.PutAsync(A.Fake<JobProfileOverviewSegmentModel>()).ConfigureAwait(false);
        ...
        public async Task PutFullJobProfileAsyncReturnsExceptionForBadStatus()
        {
            ...
            // act
            var exceptionResult = await Assert.ThrowsAsync<HttpRequestException>(async () => await httpClientService.PutAsync(A.Fake<JobProfileOverviewSegmentModel>()).ConfigureAwait(false)).ConfigureAwait(false);

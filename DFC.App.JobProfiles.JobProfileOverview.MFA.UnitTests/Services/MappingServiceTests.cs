...
namespace DFC.App.JobProfiles.JobProfileOverview.MFA.UnitTests
{
    ...
    public class MappingServiceTests
    {
        ...
        public MappingServiceTests()
        {
            ...
            {
                opts.AddProfile(new OverviewModelProfile());
            });
        ...
        private static JobProfileOverviewSegmentModel BuildExpectedResponse()
        {
            return new JobProfileOverviewSegmentModel
            {
                ...
                Data = new JobProfileOverviewSegmentDataModel
                {
                    ...
                    {
                        new App.JobProfileOverview.Data.Models.WorkingPattern
                        {
                            Id = WorkingPatternId1,
                            Title = WorkingPatternTitle1,
                            Description = WorkingPatternDescription1,
                    ...
                    HiddenAlternativeTitle = new List<App.JobProfileOverview.Data.Models.HiddenAlternativeTitle>
                    {
                        new App.JobProfileOverview.Data.Models.HiddenAlternativeTitle
                        {
                            Id = AlternativeTitleId1,
                            Title = HiddenAlternativeTitle1,
                            Description = HiddenAlternativeDescription1,
                    ...
                    JobProfileSpecialism = new List<App.JobProfileOverview.Data.Models.JobProfileSpecialism>
                    {
                        new App.JobProfileOverview.Data.Models.JobProfileSpecialism
                        {
                            Id = SpecialismId1,
                            Title = SpecialismTitle1,
                            Description = SpecialismDescription1,
                    ...
                    WorkingPatternDetails = new List<App.JobProfileOverview.Data.Models.WorkingPatternDetail>
                    {
                        new App.JobProfileOverview.Data.Models.WorkingPatternDetail
                        {
                            Id = WorkingPatternDetailId1,
                            Title = WorkingPatternDetailTitle1,
                            Description = WorkingPatternDetailDescription1,
                    ...
                    WorkingHoursDetails = new List<App.JobProfileOverview.Data.Models.WorkingHoursDetail>
                    {
                        new App.JobProfileOverview.Data.Models.WorkingHoursDetail
                        {
                            Id = WorkingHoursDetailId1,
                            Title = WorkingHoursDetailTitle1,
                            Description = WorkingHoursDetailDescription1,

...
{
    [Trait("Profile Service", "Patch Job Profile Specialism Tests")]
    public class SegmentServicePatchJobProfileSpecialismTests
    {
        ...
        public SegmentServicePatchJobProfileSpecialismTests()
        {
        ...
        [Fact]
        public async Task JobProfileOverviewSegmentServicePatchJobProfileSpecialismReturnsNotFoundWhenDocumentNotExists()
        {
            // arrange
            ...
            // act
            var result = await jobProfileOverviewSegmentService.PatchJobProfileSpecialismAsync(patchModel, documentId).ConfigureAwait(false);
        ...
        [Fact]
        public async Task JobProfileOverviewSegmentServicePatchJobProfileSpecialismReturnsAlreadyReportedWhenOutOfSequence()
        {
            // arrange
            var patchModel = A.Fake<PatchJobProfileSpecialismModel>();
            var documentId = Guid.NewGuid();
        ...
        [Fact]
        public async Task JobProfileOverviewSegmentServicePatchJobProfileSpecialismReturnsAlreadyReportedWhenEntryRequirementForDeleted()
        {
            // arrange
            var patchModel = A.Fake<PatchJobProfileSpecialismModel>();
            var documentId = Guid.NewGuid();
        ...
        [Fact]
        public async Task JobProfileOverviewSegmentServicePatchJobProfileSpecialismReturnsNotFoundWhenMissingEntryRequirementForPublished()
        {
            // arrange
            var patchModel = A.Fake<PatchJobProfileSpecialismModel>();
            var documentId = Guid.NewGuid();
        ...
        [Fact]
        public async Task JobProfileOverviewSegmentServicePatchJobProfileSpecialismReturnsOkWhenDeleted()
        {
            // arrange
            ...
            existingSegmentModel.Data.JobProfileSpecialism = new List<Data.Models.JobProfileSpecialism>
            {
        ...
        [Fact]
        public async Task JobProfileOverviewSegmentServicePatchJobProfileSpecialismReturnsNotFoundWhenCreated()
        {
            // arrange
            var patchModel = A.Fake<PatchJobProfileSpecialismModel>();
            var documentId = Guid.NewGuid();
        ...
        [Fact]
        public async Task JobProfileOverviewSegmentServicePatchJobProfileSpecialismReturnsOkWhenUpdated()
        {
            // arrange
            var patchModelId = Guid.NewGuid();
            var patchModel = A.Fake<PatchJobProfileSpecialismModel>();

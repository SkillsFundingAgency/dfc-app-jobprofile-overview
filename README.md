...
* Job Profiles Overview segments
* Draft Job Profiles Overview segments
...
|-------|-------|-------|
| DFC.App.JobProfileOverview.IntegrationTests | appsettings-template.json | appsettings.json |
| DFC.App.JobProfileOverview | appsettings-template.json | appsettings.json |
